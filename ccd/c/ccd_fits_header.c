...
/**
 * As we only have 1 CCD per control computer, we have 1 instance of the Fits_Header_Struct
 * per CCD library. This instance contains the FITS headers to be used for this CCD.
 ...
 * @see #Fits_Header
 */
int CCD_Fits_Header_Initialise(void)
{
#if LOGGING > 1
	CCD_General_Log(LOG_VERBOSITY_INTERMEDIATE,"CCD_Fits_Header_Initialise: Started.");
#endif
	Fits_Header.Card_List = NULL;
	Fits_Header.Allocated_Card_Count = 0;
	Fits_Header.Card_Count = 0;
#if LOGGING > 1
	CCD_General_Log(LOG_VERBOSITY_INTERMEDIATE,"CCD_Fits_Header_Initialise: Finished.");
#endif
	return TRUE;
}
 ...
 * @see #Fits_Header
 */
int CCD_Fits_Header_Clear(void)
{
#if LOGGING > 1
	CCD_General_Log(LOG_VERBOSITY_INTERMEDIATE,"CCD_Fits_Header_Clear: Started.");
#endif
	/* reset number of cards, without resetting allocated cards */
	Fits_Header.Card_Count = 0;
#if LOGGING > 1
	CCD_General_Log(LOG_VERBOSITY_INTERMEDIATE,"CCD_Fits_Header_Clear: Finished.");
#endif
	return TRUE;
}
...
#if LOGGING > 1
	CCD_General_Log(LOG_VERBOSITY_INTERMEDIATE,"CCD_Fits_Header_Delete: Started.");
#endif
	/* check parameters */
	if(keyword == NULL)
	{
...
#if LOGGING > 1
	CCD_General_Log(LOG_VERBOSITY_INTERMEDIATE,"CCD_Fits_Header_Delete: Finished.");
#endif
	return TRUE;
}
 ...
 * @see #Fits_Header
 */
int CCD_Fits_Header_Add_String(char *keyword,char *value,char *comment)
{
	struct Fits_Header_Card_Struct card;

#if LOGGING > 1
	CCD_General_Log(LOG_VERBOSITY_INTERMEDIATE,"CCD_Fits_Header_Add_String: Started.");
#endif
	if(keyword == NULL)
	{
	...
	CCD_General_Log_Format(LOG_VERBOSITY_INTERMEDIATE,
			       "CCD_Fits_Header_Add_String: Adding keyword %s with value %s of length %d.",
	...
	if(!Fits_Header_Add_Card(card))
		return FALSE;
#if LOGGING > 1
	CCD_General_Log(LOG_VERBOSITY_INTERMEDIATE,"CCD_Fits_Header_Add_String: Finished.");
#endif
	return TRUE;
}
 ...
 * @see #Fits_Header
 */
int CCD_Fits_Header_Add_Int(char *keyword,int value,char *comment)
{
	struct Fits_Header_Card_Struct card;

#if LOGGING > 1
	CCD_General_Log(LOG_VERBOSITY_INTERMEDIATE,"CCD_Fits_Header_Add_Int: Started.");
#endif
	if(keyword == NULL)
	{
	...
	if(!Fits_Header_Add_Card(card))
		return FALSE;
#if LOGGING > 1
	CCD_General_Log(LOG_VERBOSITY_INTERMEDIATE,"CCD_Fits_Header_Add_Int: Finished.");
#endif
	return TRUE;
}
 ...
 * @see #Fits_Header
 */
int CCD_Fits_Header_Add_Float(char *keyword,double value,char *comment)
{
	struct Fits_Header_Card_Struct card;

#if LOGGING > 1
	CCD_General_Log(LOG_VERBOSITY_INTERMEDIATE,"CCD_Fits_Header_Add_Float: Started.");
#endif
	if(keyword == NULL)
	{
	...
	if(!Fits_Header_Add_Card(card))
		return FALSE;
#if LOGGING > 1
	CCD_General_Log(LOG_VERBOSITY_INTERMEDIATE,"CCD_Fits_Header_Add_Float: Finished.");
#endif
	return TRUE;
}
 ...
 * @see #FITS_HEADER_COMMENT_STRING_LENGTH
 * @see #Fits_Header_Add_Card
 * @see ccd_general.html#CCD_GENERAL_IS_BOOLEAN
 * @see ccd_general.html#CCD_General_Log
 * @see ccd_general.html#CCD_General_Log_Format
 * @see #Fits_Header_Error_Number
 * @see #Fits_Header_Error_String
 * @see #Fits_Header
 */
int CCD_Fits_Header_Add_Logical(char *keyword,int value,char *comment)
{
	struct Fits_Header_Card_Struct card;

#if LOGGING > 1
	CCD_General_Log(LOG_VERBOSITY_INTERMEDIATE,"CCD_Fits_Header_Add_Logical: Started.");
#endif
	if(keyword == NULL)
	{
	...
	if(!Fits_Header_Add_Card(card))
		return FALSE;
#if LOGGING > 1
	CCD_General_Log(LOG_VERBOSITY_INTERMEDIATE,"CCD_Fits_Header_Add_Logical: Finished.");
#endif
	return TRUE;
}
 ...
 * @see #Fits_Header
 */
int CCD_Fits_Header_Free(void)
{
#if LOGGING > 1
	CCD_General_Log(LOG_VERBOSITY_INTERMEDIATE,"CCD_Fits_Header_Free: Started.");
#endif
	...
	Fits_Header.Allocated_Card_Count = 0;
#if LOGGING > 1
	CCD_General_Log(LOG_VERBOSITY_INTERMEDIATE,"CCD_Fits_Header_Free: Finished.");
#endif
	return TRUE;
}
 ...
 * @see #Fits_Header
 */
int CCD_Fits_Header_Write_To_Fits(fitsfile *fits_fp)
{
	int i,status,retval;
	char buff[32]; /* fits_get_errstatus returns 30 chars max */

#if LOGGING > 1
	CCD_General_Log(LOG_VERBOSITY_INTERMEDIATE,"CCD_Fits_Header_Write_To_Fits: Started.");
#endif
	status = 0;
...
#if LOGGING > 9
				CCD_General_Log_Format(LOG_VERBOSITY_INTERMEDIATE,
						       "CCD_Fits_Header_Write_To_Fits:%d: %s = %s.",i,
...
#if LOGGING > 9
				CCD_General_Log_Format(LOG_VERBOSITY_INTERMEDIATE,
						       "CCD_Fits_Header_Write_To_Fits:%d: %s = %d.",i,
						       Fits_Header.Card_List[i].Keyword,
...
#if LOGGING > 9
				CCD_General_Log_Format(LOG_VERBOSITY_INTERMEDIATE,
						       "CCD_Fits_Header_Write_To_Fits:%d: %s = %.2f.",i,
						      Fits_Header.Card_List[i].Keyword,
...
#if LOGGING > 1
	CCD_General_Log_Format(LOG_VERBOSITY_INTERMEDIATE,"CCD_Fits_Header_Write_To_Fits:Finished.");
#endif
	return TRUE;
}
...
static int Fits_Header_Add_Card(struct Fits_Header_Card_Struct card)
{
	...
	Fits_Header.Card_Count++;
#if LOGGING > 1
	CCD_General_Log(LOG_VERBOSITY_VERBOSE,"Fits_Header_Add_Card: Finished.");
#endif
	return TRUE;
