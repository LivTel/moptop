 ...
 * Moptop control system C layer. This is a telnet - type socket interaction.
...
public class Command implements Runnable, TelnetConnectionListener
{
	 ...
	 * @param address A string representing the address of the C layer, i.e. "moptop1",
	...
	public static void main(String args[])
	{
		...
		if(args.length != 3)
		{
			System.out.println("java ngat.moptop.command.Command <hostname> <port number> <command>");
			System.exit(1);
		}
		try
		{
