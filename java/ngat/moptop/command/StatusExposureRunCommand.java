 ...
 * run number (which is actually the rotation of the rotator) within the multrun used in the FITS filenames 
...
public class StatusExposureRunCommand extends IntegerReplyCommand implements Runnable
{
	...
	public static void main(String args[])
	{
		...
		if(args.length != 2)
		{
			System.out.println("java ngat.moptop.command.StatusExposureRunCommand <hostname> <port number>");
			System.exit(1);
		}
		try
		{
