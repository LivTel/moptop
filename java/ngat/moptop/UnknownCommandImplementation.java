...
public class UnknownCommandImplementation extends CommandImplementation implements JMSCommandImplementation
{
	 ...
	 * @see MoptopTCPServerConnectionThread#getMinAcknowledgeTime
	 */
	...
	public COMMAND_DONE processCommand(COMMAND command)
	{
		...
		moptop.error("Unknown Commmand:"+command.getClass().getName());
		done.setErrorNum(MoptopConstants.MOPTOP_ERROR_CODE_BASE+400);
